...
# Roadmap: edusphere MVP & Beyond

## Overview
- **MVP Goal**: Launch a working prototype to validate Manage enrollment and results for 10+ institutions.
- **Launch Timeline**: Q3 2026.
- **Success Metrics**: 1000+ users, 95% uptime.
...
|----------|--------------|-------------|--------|----------------------------|--------------|
| **Must-Have (MVP Core)** | [Feature 1] | [TBD: Core feature for edusphere. Why: Enables Manage enrollment and results for 10+ institutions.] | Not Started | 5 | None |
...
## How to Contribute
- Propose features via [GitHub Issues](https://github.com/NesoHQ/edusphere/issues/new?template=feature_request.md).
